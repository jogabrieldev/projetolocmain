...
const movementOfClient = {
    ...
    try {
      const clientUpdate = await clientRegister.updateClient(clientId , updateClient)
      res.json({ message: "Bem atualizado com sucesso", Cliente: clientUpdate });
    } catch (error) {
