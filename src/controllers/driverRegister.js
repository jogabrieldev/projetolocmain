...
const movementOfDriver = {
    ...
    registerOfDriver: async (req , res)=>{
    ...
    updateOfDrive: async(req , res )=>{
        ...
        try {
          ...
          res.json({ message: "Motorista atualizado com sucesso", Motorista: updateMoto });
